...
public class RegisterHealthEmergency extends Command {
    private static final String FULL_NAME = "models.concreteClasses.emergencies.HealthEmergency";
    private static final String MESSAGE = "Registered Public Health Emergency of level %s at %s.";
